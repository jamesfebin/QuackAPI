(ns quackapi.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [quackapi.routes.home :refer [home-routes]]
            [quackapi.routes.services :refer [service-routes]]
            [quackapi.middleware :as middleware]
            [quackapi.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "quackapi is shutting down...")
  (stop-nrepl)
